...
import com.lesenia.mobile.LoginActivity;
...
public class AccountFragment extends Fragment {
    ...
    private void initViews(View root){
        ...
        username = root.findViewById(R.id.account_username);
        ...
        pictureBtn = root.findViewById(R.id.upload_picture);
        avatarPicture = root.findViewById(R.id.avatar_picture);
        newUsernameLayout = root.findViewById(R.id.account_new_username_layout);
        newUsernameField = root.findViewById(R.id.account_new_username);
        newEmailLayout = root.findViewById(R.id.account_new_email_layout);
        newEmailField = root.findViewById(R.id.account_new_email);
